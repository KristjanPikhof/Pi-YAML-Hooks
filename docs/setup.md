...
The package lists both hosts' SDK packages as optional peer dependencies and as dev dependencies for local typechecking only. Pi compatibility checks use exact SDK pairs 0.74.0, 0.79.3, 0.80.10, and 0.84.1. End-to-end runtime behavior is checked with Pi 0.84.1 and OMP 17.0.1 and 17.2.12. Do not read those tested versions as a broader support range.
